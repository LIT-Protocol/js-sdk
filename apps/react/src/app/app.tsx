...
import * as LitJsSdk_getlitSdk from 'dist/packages/getlit-sdk';
...
import * as LitJsSdk_litStorage from 'dist/packages/lit-storage';
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_accessControlConditions['${key}']['${k}'];
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_authBrowser['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_authHelpers['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
...
>>>>>>> feat/SDK-V3
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_constants['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_contractsSdk['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_ecdsaSdk['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_encryption['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
          ...
          if(typeof LitJsSdk_getlitSdk === 'undefined') {
              console.error("LitJsSdk_getlitSdk:", LitJsSdk_getlitSdk);
          }else{
              console.warn("LitJsSdk_getlitSdk:", LitJsSdk_getlitSdk);
              window.LitJsSdk_getlitSdk = LitJsSdk_getlitSdk;
          }
          window.addEventListener('load', function() {
  
              var root = document.getElementById('root');
              var result = document.getElementById('result');
              var entries = Object.entries(LitJsSdk_getlitSdk);
              var lis = entries.map(([key, value]) => {
                  let nestedFunctions = '';
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_getlitSdk['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  return `
                  <li>
                      <div id="LitJsSdk_getlitSdk_${key}" class="key" onClick="(async (e) => {
                          var fn = LitJsSdk_getlitSdk['${key}'];
                          var fnType = typeof fn;
                          console.warn('[${key}] is type of [' + fnType + ']');
              ...
              var template = `
              <div class="cat">
                  <h1>LitJsSdk_getlitSdk has ${entries.length} functions</h1>
                  <ul>
                      ${ lis }
                  </ul>
              </div>
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_litAuthClient['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_litNodeClient['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_litNodeClientNodejs['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
          ...
          if(typeof LitJsSdk_litStorage === 'undefined') {
              console.error("LitJsSdk_litStorage:", LitJsSdk_litStorage);
          }else{
              console.warn("LitJsSdk_litStorage:", LitJsSdk_litStorage);
              window.LitJsSdk_litStorage = LitJsSdk_litStorage;
          }
          window.addEventListener('load', function() {
  
              var root = document.getElementById('root');
              var result = document.getElementById('result');
              var entries = Object.entries(LitJsSdk_litStorage);
              var lis = entries.map(([key, value]) => {
                  let nestedFunctions = '';
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_litStorage['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  return `
                  <li>
                      <div id="LitJsSdk_litStorage_${key}" class="key" onClick="(async (e) => {
                          var fn = LitJsSdk_litStorage['${key}'];
                          var fnType = typeof fn;
                          console.warn('[${key}] is type of [' + fnType + ']');
              ...
              var template = `
              <div class="cat">
                  <h1>LitJsSdk_litStorage has ${entries.length} functions</h1>
                  <ul>
                      ${ lis }
                  </ul>
              </div>
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_litThirdPartyLibs['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_miscBrowser['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_pkpClient['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_pkpCosmos['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_pkpEthers['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_pkpWalletconnect['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
                  ...
                  if (typeof value === 'object') {
                      nestedFunctions = Object.entries(value)
                          ...
                          .map(([k, v]) => `<li class='key' onClick="(async(e) => {
                            ...
                            var fn = LitJsSdk_uint8arrays['${key}']['${k}'];
                            var fnType = typeof fn;
                            console.warn('[${key}] is type of [' + fnType + ']');
...
pre {
    ...
    word-wrap: break-word;       /* Internet Explorer 5.5+ */
            ...
            />
<<<<<<< HEAD
            (REACT) THIS FILE IS AUTOMATICALLY GENERATED FROM tools/scripts/gen-react.mjs Thu, 05 Oct 2023 16:18:21 GMT
=======
            (REACT) THIS FILE IS AUTOMATICALLY GENERATED FROM tools/scripts/gen-react.mjs Mon, 09 Oct 2023 14:49:01 GMT
>>>>>>> feat/SDK-V3
            <div id="root"></div>
