...
} = require('../../src/pages/metamask/first-time-flow-page');
const { mainPageElements } = require('../../src/pages/metamask/main-page');
const { unlockPageElements } = require('../../src/pages/metamask/unlock-page');
const {
...
} = require('../../src/pages/metamask/notification-page');
const {
...
} = require('../../src/pages/metamask/settings-page');
const {
  confirmationPageElements,
} = require('../../src/pages/metamask/confirmation-page');
