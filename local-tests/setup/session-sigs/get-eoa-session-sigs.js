import { LitActionResource, LitPKPResource, generateAuthSig, createSiweMessageWithRecaps, } from '@lit-protocol/auth-helpers';
 ...
 */
export const getEoaSessionSigs = async (devEnv, person, resourceAbilityRequests) => {
...
export const getEoaSessionSigsWithCapacityDelegations = async (devEnv, fromWallet, capacityDelegationAuthSig) => {
    const centralisation = CENTRALISATION_BY_NETWORK[devEnv.litNodeClient.config.litNetwork];
    if (centralisation === 'decentralised') {
        console.warn('Decentralised network detected. Adding superCapacityDelegationAuthSig to eoaSessionSigs');
    }
...
//# sourceMappingURL=get-eoa-session-sigs.js.map