 ...
 */
export const testDelegatingCapacityCreditsNFTToAnotherPkpToExecuteJs = async (devEnv) => {
    ...
    const scopes = await bob.contractsClient.pkpPermissionsContract.read.getPermittedAuthMethodScopes(bob.authMethodOwnedPkp.tokenId, AUTH_METHOD_TYPE.EthWallet, bobsAuthMethodAuthId, 3);
    ...
    const capacityDelegationAuthSig = await alice.createCapacityDelegationAuthSig([bob.authMethodOwnedPkp.ethAddress]);
...
//# sourceMappingURL=testDelegatingCapacityCreditsNFTToAnotherPkpToExecuteJs.js.map