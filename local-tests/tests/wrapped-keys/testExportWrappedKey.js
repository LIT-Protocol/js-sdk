 ...
 */
export const testExportWrappedKey = async (devEnv) => {
    const alice = await devEnv.createRandomPerson();
    try {
        const pkpSessionSigsImport = await getPkpSessionSigs(devEnv, alice, null, new Date(Date.now() + 1000 * 60 * 10).toISOString()); // 10 mins expiry
...
//# sourceMappingURL=testExportWrappedKey.js.map