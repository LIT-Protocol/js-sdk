 ...
 */
export const testFailEthereumSignTransactionWrappedKeyWithInvalidParam = async (devEnv) => {
    ...
    try {
        ...
        try {
            ...
            if (e.message.includes('invalid hexlify value')) {
                ...
                console.log('✅ testFailEthereumSignTransactionWrappedKeyWithInvalidParam is expected to have an error');
            }
            else {
...
//# sourceMappingURL=testFailEthereumSignTransactionWrappedKeyWithInvalidParam.js.map