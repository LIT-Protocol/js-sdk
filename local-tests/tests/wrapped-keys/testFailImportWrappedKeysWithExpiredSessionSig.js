 ...
 */
export const testFailImportWrappedKeysWithExpiredSessionSig = async (devEnv) => {
    ...
    try {
        ...
        if (e.message.includes('Invalid sessionSig: Expired')) {
            ...
            console.log('✅ testFailImportWrappedKeysWithExpiredSessionSig is expected to have an error');
        }
        else {
            throw e;
        }
    }
    console.log('✅ testFailImportWrappedKeysWithExpiredSessionSig');
};
//# sourceMappingURL=testFailImportWrappedKeysWithExpiredSessionSig.js.map