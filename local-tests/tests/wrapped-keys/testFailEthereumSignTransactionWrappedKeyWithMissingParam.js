 ...
 */
export const testFailEthereumSignTransactionWrappedKeyWithMissingParam = async (devEnv) => {
    ...
    try {
        ...
        try {
            ...
            if (e.message.includes('Missing required field: toAddress')) {
                ...
                console.log('✅ testFailEthereumSignTransactionWrappedKeyWithMissingParam is expected to have an error');
            }
            else {
                throw e;
            }
...
//# sourceMappingURL=testFailEthereumSignTransactionWrappedKeyWithMissingParam.js.map