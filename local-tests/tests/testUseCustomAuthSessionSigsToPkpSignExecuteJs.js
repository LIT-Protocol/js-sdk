...
import { AUTH_METHOD_SCOPE, CENTRALISATION_BY_NETWORK, LIT_ABILITY, } from '@lit-protocol/constants';
 ...
 */
export const testUseCustomAuthSessionSigsToPkpSignExecuteJs = async (devEnv) => {
     ...
     */
    const addPermittedAuthMethodReceipt = await alice.contractsClient.addPermittedAuthMethod({
    ...
    console.log('✅ addPermittedAuthMethodReceipt:', addPermittedAuthMethodReceipt);
    /**
    ...
    const addPermittedActionReceipt = await alice.contractsClient.addPermittedAction({
        ipfsId: IPFSID,
        pkpTokenId: alice.pkp.tokenId,
        authMethodScopes: [AUTH_METHOD_SCOPE.SignAnything],
    });
...
//# sourceMappingURL=testUseCustomAuthSessionSigsToPkpSignExecuteJs.js.map