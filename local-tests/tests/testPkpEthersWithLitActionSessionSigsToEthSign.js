 ...
 */
export const testPkpEthersWithLitActionSessionSigsToEthSign = async (devEnv) => {
    ...
    try {
        ...
        if (recoveredAddr !== alice.pkp.ethAddress) {
            throw new Error(`❌ test eth_sign recoveredAddr should be ${alice.pkp.ethAddress} but got ${recoveredAddr}`);
        }
...
//# sourceMappingURL=testPkpEthersWithLitActionSessionSigsToEthSign.js.map