 ...
 */
export const testUseValidLitActionIpfsCodeGeneratedSessionSigsToExecuteJsSigning = async (devEnv) => {
    const alice = await devEnv.createRandomPerson();
    const litActionSessionSigs = await getLitActionSessionSigsUsingIpfsId(devEnv, alice, [
        {
...
//# sourceMappingURL=testUseValidLitActionIpfsCodeGeneratedSessionSigsToExecuteJsSigning.js.map