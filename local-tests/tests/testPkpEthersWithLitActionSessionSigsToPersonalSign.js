 ...
 */
export const testPkpEthersWithLitActionSessionSigsToPersonalSign = async (devEnv) => {
    ...
    try {
        ...
        if (recoveredAddr !== alice.pkp.ethAddress) {
            throw new Error(`❌ recoveredAddr should be ${alice.pkp.ethAddress} but got ${recoveredAddr}`);
        }
...
//# sourceMappingURL=testPkpEthersWithLitActionSessionSigsToPersonalSign.js.map