 ...
 */
export const testUseCapacityDelegationAuthSigWithUnspecifiedCapacityTokenIdToExecuteJs = async (devEnv) => {
    ...
    const bobsSessionSigs = await getEoaSessionSigsWithCapacityDelegations(devEnv, bob.wallet, appOwnersCapacityDelegationAuthSig);
...
//# sourceMappingURL=testUseCapacityDelegationAuthSigWithUnspecifiedCapacityTokenIdToExecuteJs.js.map