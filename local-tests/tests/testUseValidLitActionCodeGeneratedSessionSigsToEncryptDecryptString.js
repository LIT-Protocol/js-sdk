 ...
 *
 */
export const testUseValidLitActionCodeGeneratedSessionSigsToEncryptDecryptString = async (devEnv) => {
    ...
    if (decryptRes !== 'Hello world') {
        throw new Error(`Expected decryptRes to be 'Hello world' but got ${decryptRes}`);
    }
};
//# sourceMappingURL=testUseValidLitActionCodeGeneratedSessionSigsToEncryptDecryptString.js.map