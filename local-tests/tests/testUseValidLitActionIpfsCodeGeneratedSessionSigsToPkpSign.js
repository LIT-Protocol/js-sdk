 ...
 *
 **/
export const testUseValidLitActionIpfsCodeGeneratedSessionSigsToPkpSign = async (devEnv) => {
    const alice = await devEnv.createRandomPerson();
    let litActionSessionSigs;
    try {
        litActionSessionSigs = await getLitActionSessionSigsUsingIpfsId(devEnv, alice);
    }
    catch (e) {
...
//# sourceMappingURL=testUseValidLitActionIpfsCodeGeneratedSessionSigsToPkpSign.js.map