// Usage:
// DEBUG=true NETWORK=manzano yarn test:e2e:nodejs --filter=test-rli-mint-second.mjs
...
export async function main() {
  ...
  const REQUESTS_PER_KILLOSECOND = REQUESTS_PER_SECOND * 1000; // 1000 requests per kilosecond
