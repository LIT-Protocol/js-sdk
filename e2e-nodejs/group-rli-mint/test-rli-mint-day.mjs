// Usage:
// DEBUG=true NETWORK=manzano yarn test:e2e:nodejs --filter=test-rli-mint-day.mjs
...
export async function main() {
  ...
  const REQUESTS_PER_DAY = 20000;
  const REQUESTS_PER_KILLOSECOND = REQUESTS_PER_DAY * (1 / 24 / 60 / 60) * 1000; // 20000 requests per day
