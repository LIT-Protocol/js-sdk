...
import type {
  DomainWaleltRegistry,
  DomainWaleltRegistryInterface,
} from "../DomainWaleltRegistry";
...
export class DomainWaleltRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): DomainWaleltRegistryInterface {
    return new utils.Interface(_abi) as DomainWaleltRegistryInterface;
  }
  static connect(
    address: string,
