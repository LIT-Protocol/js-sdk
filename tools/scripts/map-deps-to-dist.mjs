...
if (args[0] === '--help') {
    redLog('# Usage: node tools/scripts/map-deps-to-dist <path-to-packages-dir> <path-to-dist-dir>');
    exit();
}
...
if (!PACKAGES_DIR || !DIST_DIR || !FILTER) {
    redLog('Missing arguments <path-to-packages-dir> <path-to-dist-dir> <filter>');
    exit();
}
