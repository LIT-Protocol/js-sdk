...
If you're using one of the testnets: Naga Dev or Test, you'll connect to Chronicle Yellowstone, while production applications using Naga Mainnet will use the Lit Chain. Configuration details for both networks are below:
