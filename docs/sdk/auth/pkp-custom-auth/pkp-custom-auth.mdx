...
```
  ...
  <Step title="Create and Pin Validation Lit Action">
    ...
    <Note>
    🔍 <b>IPFS Visibility Required</b>: The IPFS CID must be publicly accessible via the Lit Explorer. If the CID isn't visible on explorer.litprotocol.com, the Lit nodes won't be able to fetch and execute your validation logic.
    </Note>
