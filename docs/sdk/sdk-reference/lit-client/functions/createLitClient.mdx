...
<ResponseField name="result" type="PaymentManager Object">
  <Expandable title="properties" defaultOpen={true}>
    <ResponseField name="deposit(params)" type="Promise<LitTxVoid>">
      ...
      <Expandable title="params">
        <ResponseField name="amountInLitkey" type="string" required>
          Amount to deposit in LITKEY (e.g. "0.1").
        </ResponseField>
      </Expandable>
      <Expandable title="example">
```ts
...
```
    ...
    <ResponseField name="depositForUser(params)" type="Promise<LitTxVoid>">
      ...
      <Expandable title="params">
        ...
        <ResponseField name="amountInLitkey" type="string" required>
          Amount to deposit in LITKEY (e.g. "0.25").
        </ResponseField>
      </Expandable>
      <Expandable title="example">
```ts
await paymentManager.depositForUser({ userAddress: "0x...", amountInLitkey: "0.25" });
```
      </Expandable>
    </ResponseField>
...
```
    ...
    <ResponseField name="requestWithdraw(params)" type="Promise<LitTxVoid>">
      ...
      <Expandable title="params">
        <ResponseField name="amountInLitkey" type="string" required>
          Amount to withdraw in LITKEY (e.g. "0.05").
        </ResponseField>
      </Expandable>
      <Expandable title="example">
```ts
...
```
    ...
    <ResponseField name="withdraw(params)" type="Promise<LitTxVoid>">
      ...
      <Expandable title="example">
```ts
await paymentManager.withdraw({ amountInLitkey: "0.05" });
```
      </Expandable>
    </ResponseField>
