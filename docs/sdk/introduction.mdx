...
<Tip>
Lit v1 ("Naga") is live on [testnet](https://spark.litprotocol.com/naga-test/). If you're looking to deploy in production, you can use Lit v0 ("Datil"), live today. [Link](https://developer.litprotocol.com/).
</Tip>
