...
<Tip>
The Naga Mainnet is now live! Check out the blog post [here](https://spark.litprotocol.com/v1-live/).

  You can stake your tokens to support the network and earn rewards via the [Staking Portal](https://staking.litprotocol.com/).
</Tip>
