...
If you're looking to deploy in production today before the Naga Mainnet is live, you can use the Datil Mainnet Beta which is live today. [Docs](https://developer.litprotocol.com/).
</Tip>
