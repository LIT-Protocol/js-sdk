...
At the onset of Lit v1, the Lit Protocol Council will be tasked with overseeing the governance process in tandem with \$LITKEY token holders, as covered in depth in the [governance section](/goverance/overview).
