...
The initial node operator set has been selected via a staking contest that ran after Lit’s token generation event (TGE).  You can always stake your tokens to support the network and earn rewards via the [Staking Portal](https://staking.litprotocol.com/).
