...
At this time, the Lit Protocol development company will be the primary party tasked with creating and submitting new LIPs. However, anyone can suggest improvements or changes by starting a discussion on the Lit [governance forum](https://lit.discourse.group/). All suggestions will be reviewed and prioritized according to current protocol objectives and available resources.
