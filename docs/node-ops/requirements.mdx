...
- Genesis Validator Set: The first group of mainnet validators was chosen via staking and delegation. At the end of the staking contest, the top 10 operators based on their total stake weight were selected as the genesis validator set. Read more about the initial selection process in the [Staking Contest Docs](/node-ops/staking-contest/logistics).
