import { CheckAndSignAuthParams, ELeft, ERight, IEither, IEitherErrorType, JsonAuthSig, LIT_CHAINS, LIT_ERROR, LOCAL_STORAGE_KEYS } from "@litprotocol-dev/constants";
