...
describe('contractsSdk', () => {
  ...
  it('should create an instance with a private key', async () => {
    ...
    const privateKey = '0xada150c6c8be33c47db2725ee7e789d932ef5121820d75359a32427438f2a379';
    ...
    expect(await litContracts_privateKeySigner.signer.getAddress()).toBe('0x30F1Bb983e8D27646E294d4f570a4FAA7Ca096a6');
