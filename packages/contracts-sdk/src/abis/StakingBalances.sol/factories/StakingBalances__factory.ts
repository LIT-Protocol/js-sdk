...
import type {
  StakingBalances,
  StakingBalancesInterface,
} from '../StakingBalances';
...
export class StakingBalances__factory {
  static readonly abi = _abi;
  static createInterface(): StakingBalancesInterface {
    return new utils.Interface(_abi) as StakingBalancesInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): StakingBalances {
    return new Contract(address, _abi, signerOrProvider) as StakingBalances;
  }
}
