...
describe('getFirstSessionSig from sessionSigs record', () => {
  ...
  it('should correctly extract first sessionSig', () => {
    ...
    const signedMessage: SessionKeySignedMessage = JSON.parse(firstSessionSig.signedMessage);
...
describe('getPkpAddressFromSessionSig from (first) pkpSessionSig', () => {
    ...
    it('should throw an error for EOA sessionSig', () => {
        const eoaSessionSigs = {
            ...
            address: '4afd2573c82608c54a2c52c77dfbb13595b4f87d93ebc299459a06a7f698b8f1',
            algo: 'ed25519'
        };
        expect(() => getPkpAddressFromSessionSig(eoaSessionSigs)).toThrowError('SessionSig is not from a PKP');
    });
});