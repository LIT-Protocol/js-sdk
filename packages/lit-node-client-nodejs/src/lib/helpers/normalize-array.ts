 ...
 *
 * Context: the nodes will only accept a normal array type as a parameter due to serizalization issues with Uint8Array type. this loop below is to normalize the message to a basic array.
 *
