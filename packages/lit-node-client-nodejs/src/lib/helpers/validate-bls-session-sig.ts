...
export const blsSessionSigVerify = (verifier: (public_key: any, message: any, signature: any) => void, networkPubKey: string, authSig: AuthSig): void => {
    ...
    const shaHashed = ethers.utils.base64.encode(ethers.utils.sha256(prefixedEncoded)); 
