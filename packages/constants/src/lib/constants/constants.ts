...
export const LIT_CHAINS: LITChain<LitEVMChainKeys, LITEVMChain> = {
  ...
  eluvio: {
    ...
    symbol: 'ELV',
    decimals: 18,
    rpcUrls: ['https://host-76-74-29-2.contentfabric.io/eth'],
  ...
  kaia: {
    ...
    symbol: 'KAIA',
    decimals: 18,
    rpcUrls: ['https://rpc.ankr.com/kaia'],
  ...
  storyOdyssey: {
    ...
    symbol: 'IP',
    decimals: 18,
    rpcUrls: ['https://evm-rpc.story.testnet.dteam.tech'],
...
export const LIT_COSMOS_CHAINS: LITChain<LitCosmosChainKeys, LITCosmosChain> = {
  ...
  kyve: {
    ...
    decimals: 6,
    chainId: 'korellia',
    rpcUrls: ['https://rpc.korellia.kyve.network'],
