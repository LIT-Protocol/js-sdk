...
var custom_network_signatures_exports = {};
__export(custom_network_signatures_exports, {
  generateSignaturesFromContext: () => generateSignaturesFromContext
});
module.exports = __toCommonJS(custom_network_signatures_exports);
...
function getBaseDirectory(useScriptDirectory = false, callerPath) {
  if (useScriptDirectory) {
    if (callerPath) {
      const callerDir = (0, import_path.dirname)((0, import_url.fileURLToPath)(callerPath));
    ...
    const moduleDir = (0, import_path.dirname)((0, import_url.fileURLToPath)(import_meta.url));
...
var currentScriptPath = (0, import_url.fileURLToPath)(import_meta.url);
