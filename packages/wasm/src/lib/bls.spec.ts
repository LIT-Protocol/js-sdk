...
import { blsCombine, blsDecrypt, blsEncrypt, BlsSignatureShareJsonString, blsVerify } from '..';

const blsRootkeyHexBuffer = Buffer.from("8acb0d87dcd4fc8ecb971690b5aa28ed74b205ae449dbb558729c7cff87eec278a6959eb3ee3c03366e0eabac42db3e4", 'hex');
...
describe('BLS', () => {
  ...
  it("should combine and verify", async () => {
    ...
    const toSignUint8Array = [94, 92, 103, 65, 185, 206, 89, 188, 160, 211, 160, 232, 203, 51, 92, 235, 243, 181, 232, 115, 244, 199, 191, 119, 121, 130, 217, 182, 185, 151, 37, 32];
  ...
  it('should decrypt', async () => {
    ...
    const cipherTextBase64 = Buffer.from("kyQOLL1FMmXIw3JHeEhuIj2o4NjUqEAnA/Fnrwiw2Ax/gWe8Wwm0CBnjbkOn/mMXVAVGUrjEcbLzMTnecWtGly1v77RST6Ml2YN0pYeraRUgrQil+Kk9GJwnI6oLI/ur7OI8iUcOeKrte5RbIBnyGTQC", 'base64');
