...
const blsRootkeyHexBuffer = Buffer.from(
  '99becf3f854c2073b06e4bdb5653f72d0b37615eb12e8e64d58db25568cbff66de804b9af7f90be4c87884adab52c50b',
  'hex'
);
...
const identityParamsUtf8Buffer = Buffer.from(
  'lit-accesscontrolcondition://998a67a9f2a362bd00a884bb7ac1252a470c7396fdd877a3d9a51c96fbf3ea63/64ec88ca00b268e5ba1a35678a1b5316d212f4f366b2477232534a8aeca37f3c',
  'utf8'
);

const cipherText = Buffer.from(
  'gde2ccRMkMpC42544vHngsOG2Wdl5a7IpeTNmq+h0FKzVargGrOWToM48pc02EtHXSyewu8Khrr1YlF+l4xo4pR2tApEnIYp/22zQgS2LvcgURe9pbcLeJ57fsxsdbrmMQVgg6hPcqbmWT4tU0+7KTAC',
  'base64'
);
...
describe('BLS', () => {
  ...
  it('should combine signatures', async () => {
    const combinedSignature = await blsCombine(
      'Bls12381G2',
