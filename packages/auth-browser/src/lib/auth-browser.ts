 ...
 *
 * !! NOTE !!
 * This function is purely used for crafting the authSig for access control conditions, encryption & decryption. For SessionSigs, you won't be able to use this
