/**
 * Stytch WhatsApp OTP authentication routes
 * Handles WhatsApp OTP send and verify operations
 */

import { Elysia, t } from 'elysia';
import { resp } from '../../../response-helpers/response-helpers';

export const stytchWhatsAppRoutes = <
  T extends Elysia<any, any, any, any, any, any, any>
>(
  app: T
): T => {
  // =============================================================
  //      SEND: Stytch WhatsApp OTP (/auth/stytch/whatsapp)
  // =============================================================
  app.post(
    '/stytch/whatsapp/send-otp',
    ...
    },
    {
      ...
      detail: {
        summary: 'Send Stytch WhatsApp OTP',
        description:
          'Initiates the Stytch WhatsApp OTP login or creation process.',
        tags: ['Auth - Stytch'],
      },
    }
  );
  ...
  // =============================================================
  //        VERIFY: Stytch WhatsApp OTP (/auth/stytch/whatsapp)
  // =============================================================
  app.post(
    '/stytch/whatsapp/verify-otp',
    async ({ body, stytchClient }) => {
      try {
    ...
    },
    {
      ...
      detail: {
        summary: 'Verify Stytch WhatsApp OTP',
        description:
          'Verifies the WhatsApp OTP and returns a Stytch session JWT.',
        tags: ['Auth - Stytch'],
      },
    }
  );
